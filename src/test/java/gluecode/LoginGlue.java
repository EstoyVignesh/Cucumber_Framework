...
public class LoginGlue extends Utils {
	...
	public void i_enter_the_correct_username() {
		try
		{
			driver.findElement(By.id("modalusername")).sendKeys("vickyphysics1998@gmail.com");
			Thread.sleep(2000);
	...
	public void i_enter_the_correct_password() {
		try
		{
			driver.findElement(By.xpath("//input[@name='current-password']")).sendKeys("@Vigneshguvi11");
			Thread.sleep(2000);
